...
export default function EstadiosHome() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col font-bold">
      <ContainerHeader>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
            <div className="relative flex-grow w-full">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#007a33] outline-none shadow-sm font-bold" 
              />
            </div>

            <button className="bg-[#007a33] hover:bg-[#005f27] text-white font-bold py-2.5 px-6 rounded-lg shadow-sm transition-all flex items-center gap-2 whitespace-nowrap cursor-pointer">
