      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-md flex justify-between items-center group hover:border-emerald-200 transition-colors">
          <div className="flex-1">
            ...
            <p className="text-[10px] md:text-xs text-gray-500">vs PSzinho - PA (Casa)</p>
          </div>
          <div className="ml-3 shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 md:w-9 md:h-9" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-md flex justify-between items-center group hover:border-emerald-200 transition-colors">
          <div className="flex-1">
            <p className="text-[9px] font-bold text-gray-500 uppercase">Vitórias na Temporada</p>
            <div className="text-2xl md:text-3xl font-bold text-gray-800 mt-0.5">9</div>
          </div>
          <div className="ml-3 shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 md:w-9 md:h-9" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div
          onClick={() => router.push(CADASTRAR_TIME_ROUTE)}
          className="bg-white border border-gray-100 rounded-xl p-4 shadow-md flex justify-between items-center cursor-pointer hover:border-emerald-200 transition-colors"
        >
          <div className="flex-1">
            <p className="text-[9px] font-bold text-gray-500 uppercase">Elenco</p>
            <div className="text-lg md:text-xl font-bold text-gray-800 mt-0.5">Gerenciar Elenco</div>
            <p className="text-[10px] md:text-xs text-gray-500">Cadastrar e editar jogadores</p>
          </div>
          <Users className="w-8 h-8 md:w-9 md:h-9 text-emerald-500 shrink-0 ml-3" />
        </div>

      </div>

      <div className="bg-white border border-gray-100 rounded-lg p-4 shadow-md">
        <h3 className="text-xs font-bold text-gray-700 mb-2">Classificação - Top 5</h3>
        <div className="space-y-1.5">
          {classificacao.map((item) => (
            ...
            >
              <div className="w-8 font-bold">{item.pos}</div>
