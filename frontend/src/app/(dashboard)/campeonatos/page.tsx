    ...
    <div className="min-h-screen bg-gray-100 flex flex-col font-bold" data-testid="page-campeonatos">
      <div className="w-full max-w-6xl mx-auto px-6 pt-4 pb-20 text-gray-900" data-testid="container-campeonatos">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
          ...
          <button data-testid="btn-criar-campeonato" className="bg-[#007a33] hover:bg-[#005f27] text-white font-bold py-2.5 px-6 rounded-lg shadow-sm transition-all flex items-center gap-2 whitespace-nowrap cursor-pointer text-sm">
