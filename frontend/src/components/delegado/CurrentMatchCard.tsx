      ...
      <div className="grid grid-cols-1 gap-4 p-4 sm:grid-cols-[280px_1fr] sm:items-stretch">
        ...
        <div className="flex flex-col justify-between gap-4">
          ...
          <div className="flex flex-col p-2 gap-2 sm:items-end">
            <Link
              href={registerHref}
              className="inline-flex w-full items-center justify-center rounded-full bg-[#136B19] px-4 py-3 text-sm font-semibold text-white hover:bg-emerald-800 transition cursor-pointer sm:w-auto"
            >
              Registrar Súmula
            </Link>
            ...
            <button
              onClick={onCancel}
              className="inline-flex w-full items-center justify-center rounded-sm bg-red-600 px-4 py-2 text-sm font-semibold text-white hover:bg-red-700 transition cursor-pointer sm:w-auto"
            >
              Cancelar Partida
            </button>
          </div>
