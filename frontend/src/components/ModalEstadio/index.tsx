...
return (
  ...
  >
    <div 
      ref={modalRef}
      className="bg-white rounded-xl shadow-2xl w-full max-w-lg p-8 px-8 flex flex-col items-start text-left animate-in fade-in zoom-in duration-200 font-roboto"
    > 
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 w-full max-w-md">
        ...
        <div className="flex justify-end gap-3 mt-8 w-full pr-0">
          ...
          <button 
            type="submit" 
            className="px-4 py-1.5 bg-[#004a1b] text-white rounded-md text-xs font-bold hover:bg-green-800 transition-all"
          >
            Adicionar
          </button>
        </div>
